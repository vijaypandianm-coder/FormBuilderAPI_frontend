...
var scrollDroppable = (droppable2, newScroll) => {
  !droppable2.frame ? true ? invariant() : invariant() : void 0;
...
var moveToNextCombine = ({
  ...
  !(indexOfClosest !== -1) ? true ? invariant(false, "Could not find displaced item in set") : invariant() : void 0;
...
var moveToNextIndex = ({
  ...
  !wasAt ? true ? invariant(false, "Cannot move in direction without previous impact location") : invariant() : void 0;
...
var whenCombining = ({
  ...
  !combine2 ? true ? invariant() : invariant() : void 0;
...
var getKnownActive = (droppable2) => {
  ...
  !rect ? true ? invariant(false, "Cannot get clipped area from droppable") : invariant() : void 0;
  return rect;
};
...
var addPlaceholder = (droppable2, draggable2, draggables) => {
  const frame = droppable2.frame;
  !!isHomeOf(draggable2, droppable2) ? true ? invariant(false, "Should not add placeholder space to home list") : invariant() : void 0;
  !!droppable2.subject.withPlaceholder ? true ? invariant(false, "Cannot add placeholder size to a subject when it already has one") : invariant() : void 0;
...
var removePlaceholder = (droppable2) => {
  ...
  !added ? true ? invariant(false, "Cannot remove placeholder form subject when there was none") : invariant() : void 0;
  const frame = droppable2.frame;
  if (!frame) {
    const subject2 = getSubject({
      page: droppable2.subject.page,
  ...
  !oldMaxScroll ? true ? invariant(false, "Expected droppable with frame to have old max frame scroll when removing placeholder") : invariant() : void 0;
...
var refreshSnap = ({
  ...
  !(state.movementMode === "SNAP") ? true ? invariant() : invariant() : void 0;
  ...
  !isOver ? true ? invariant(false, "Must be over a destination in SNAP movement mode") : invariant() : void 0;
...
var getLiftEffect = ({
  ...
  !(rawIndex !== -1) ? true ? invariant(false, "Expected draggable to be inside home list") : invariant() : void 0;
...
var getFrame = (droppable2) => {
  const frame = droppable2.frame;
  !frame ? true ? invariant(false, "Expected Droppable to have a frame") : invariant() : void 0;
  return frame;
};
...
var reducer = (state = idle$2, action) => {
  ...
  if (action.type === "INITIAL_PUBLISH") {
    !(state.phase === "IDLE") ? true ? invariant(false, "INITIAL_PUBLISH must come after a IDLE phase") : invariant() : void 0;
    const {
      critical,
      clientSelection,
      viewport,
  ...
  if (action.type === "COLLECTION_STARTING") {
    ...
    !(state.phase === "DRAGGING") ? true ? invariant(false, `Collection cannot start from phase ${state.phase}`) : invariant() : void 0;
    const result = {
      ...state,
      phase: "COLLECTING"
    };
  ...
  if (action.type === "PUBLISH_WHILE_DRAGGING") {
    !(state.phase === "COLLECTING" || state.phase === "DROP_PENDING") ? true ? invariant(false, `Unexpected ${action.type} received in phase ${state.phase}`) : invariant() : void 0;
  ...
  if (action.type === "MOVE") {
    ...
    !isMovementAllowed(state) ? true ? invariant(false, `${action.type} not permitted in phase ${state.phase}`) : invariant() : void 0;
    const {
  ...
  if (action.type === "UPDATE_DROPPABLE_IS_ENABLED") {
    ...
    !isMovementAllowed(state) ? true ? invariant(false, `Attempting to move in an unsupported phase ${state.phase}`) : invariant() : void 0;
    const {
      id,
      isEnabled
    } = action.payload;
    const target = state.dimensions.droppables[id];
    !target ? true ? invariant(false, `Cannot find Droppable[id: ${id}] to toggle its enabled state`) : invariant() : void 0;
  ...
  if (action.type === "UPDATE_DROPPABLE_IS_COMBINE_ENABLED") {
    ...
    const target = state.dimensions.droppables[id];
    !target ? true ? invariant(false, `Cannot find Droppable[id: ${id}] to toggle its isCombineEnabled state`) : invariant() : void 0;
  ...
  if (action.type === "MOVE_BY_WINDOW_SCROLL") {
    ...
    !isMovementAllowed(state) ? true ? invariant(false, `Cannot move by window in phase ${state.phase}`) : invariant() : void 0;
    !state.isWindowScrollAllowed ? true ? invariant(false, "Window scrolling is currently not supported for fixed lists") : invariant() : void 0;
  ...
  if (action.type === "MOVE_UP" || action.type === "MOVE_DOWN" || action.type === "MOVE_LEFT" || action.type === "MOVE_RIGHT") {
    ...
    !(state.phase === "DRAGGING") ? true ? invariant(false, `${action.type} received while not in DRAGGING phase`) : invariant() : void 0;
  ...
  if (action.type === "DROP_PENDING") {
    ...
    !(state.phase === "COLLECTING") ? true ? invariant(false, "Can only move into the DROP_PENDING phase from the COLLECTING phase") : invariant() : void 0;
    const newState = {
      ...state,
      phase: "DROP_PENDING",
      isWaiting: true,
  ...
  if (action.type === "DROP_ANIMATE") {
    ...
    !(state.phase === "DRAGGING" || state.phase === "DROP_PENDING") ? true ? invariant(false, `Cannot animate drop from phase ${state.phase}`) : invariant() : void 0;
    const result = {
...
var lift = (marshal) => ({
  ...
  !(getState().phase === "IDLE") ? true ? invariant(false, "Unexpected phase to start a drag") : invariant() : void 0;
  dispatch(flush());
...
var dropMiddleware = ({
  ...
  !!isWaitingForDrop ? true ? invariant(false, "A DROP action occurred while DROP_PENDING and still waiting") : invariant() : void 0;
  !(state.phase === "DRAGGING" || state.phase === "DROP_PENDING") ? true ? invariant(false, `Cannot drop in phase: ${state.phase}`) : invariant() : void 0;
...
function getScrollListener({
  ...
  function start2() {
    !!isActive2() ? true ? invariant(false, "Cannot start scroll listener when already active") : invariant() : void 0;
    unbind = bindEvents(window, [binding]);
  }
  function stop() {
    !isActive2() ? true ? invariant(false, "Cannot stop scroll listener when not active") : invariant() : void 0;
    scheduled.cancel();
    unbind();
    unbind = noop$2;
  }
...
var getAsyncMarshal = () => {
  ...
  const execute2 = (timerId) => {
    ...
    !(index !== -1) ? true ? invariant(false, "Could not find timer") : invariant() : void 0;
...
var getPublisher = (getResponders, announce) => {
  ...
  const beforeCapture = (draggableId, mode) => {
    !!dragging ? true ? invariant(false, "Cannot fire onBeforeCapture as a drag start has already been published") : invariant() : void 0;
  ...
  const beforeStart = (critical, mode) => {
    !!dragging ? true ? invariant(false, "Cannot fire onBeforeDragStart as a drag start has already been published") : invariant() : void 0;
  ...
  const update2 = (critical, impact) => {
    ...
    const combine2 = tryGetCombine(impact);
    !dragging ? true ? invariant(false, "Cannot fire onDragMove when onDragStart has not been called") : invariant() : void 0;
  ...
  const flush2 = () => {
    !dragging ? true ? invariant(false, "Can only flush responders while dragging") : invariant() : void 0;
    asyncMarshal.flush();
  };
  const drop2 = (result) => {
    !dragging ? true ? invariant(false, "Cannot fire onDragEnd when there is no matching onDragStart") : invariant() : void 0;
    dragging = null;
...
var dropAnimationFinishMiddleware = (store) => (next) => (action) => {
  ...
  const state = store.getState();
  !(state.phase === "DROP_ANIMATING") ? true ? invariant(false, "Cannot finish a drop animating when no drop is occurring") : invariant() : void 0;
...
var autoScroll = (autoScroller) => (store) => (next) => (action) => {
  ...
  if (guard(action, "INITIAL_PUBLISH")) {
    next(action);
    const state = store.getState();
    !(state.phase === "DRAGGING") ? true ? invariant(false, "Expected phase to be DRAGGING after INITIAL_PUBLISH") : invariant() : void 0;
...
var getDocumentElement = () => {
  ...
  !doc ? true ? invariant(false, "Cannot find document.documentElement") : invariant() : void 0;
  return doc;
};
...
var createDimensionMarshal = (registry, callbacks) => {
  ...
  const updateDroppableIsEnabled2 = (id, isEnabled) => {
    !registry.droppable.exists(id) ? true ? invariant(false, `Cannot update is enabled flag of Droppable ${id} as it is not registered`) : invariant() : void 0;
    if (!collection) {
      return;
    }
  ...
  const updateDroppableIsCombineEnabled2 = (id, isCombineEnabled) => {
    ...
    !registry.droppable.exists(id) ? true ? invariant(false, `Cannot update isCombineEnabled flag of Droppable ${id} as it is not registered`) : invariant() : void 0;
  ...
  const updateDroppableScroll2 = (id, newScroll) => {
    ...
    !registry.droppable.exists(id) ? true ? invariant(false, `Cannot update the scroll on Droppable ${id} as it is not registered`) : invariant() : void 0;
  ...
  const subscriber = (event) => {
    !collection ? true ? invariant(false, "Should only be subscribed when a collection is occurring") : invariant() : void 0;
  ...
  const startPublishing = (request) => {
    !!collection ? true ? invariant(false, "Cannot start capturing critical dimensions as there is already a collection") : invariant() : void 0;
...
var getScrollableDroppableOver = (target, droppables) => {
  const maybe = getScrollableDroppables(droppables).find((droppable2) => {
    !droppable2.frame ? true ? invariant(false, "Invalid result") : invariant() : void 0;
...
var createFluidScroller = ({
  ...
  const tryScroll = (state) => {
    !dragging ? true ? invariant(false, "Cannot fluid scroll if not dragging") : invariant() : void 0;
    const {
      shouldUseTimeDampening,
      dragStartTime
    } = dragging;
  ...
  const start$1 = (state) => {
    start();
    !!dragging ? true ? invariant(false, "Cannot start auto scrolling when already started") : invariant() : void 0;
...
var createJumpScroller = ({
  ...
  const jumpScroller = (state) => {
    ...
    !destination ? true ? invariant(false, "Cannot perform a jump scroll when there is no destination") : invariant() : void 0;
...
var getHead = () => {
  ...
  !head ? true ? invariant(false, "Cannot find the head to append a style to") : invariant() : void 0;
  return head;
};
...
function useStyleMarshal(contextId, nonce) {
  ...
  const setDynamicStyle = useCallback2(memoizeOne((proposed) => {
    ...
    !el ? true ? invariant(false, "Cannot set dynamic style element if it is not set") : invariant() : void 0;
  ...
  useIsomorphicLayoutEffect2(() => {
    !(!alwaysRef.current && !dynamicRef.current) ? true ? invariant(false, "style elements already mounted") : invariant() : void 0;
    ...
    return () => {
      const remove = (ref2) => {
        ...
        !current ? true ? invariant(false, "Cannot unmount ref as it is not set") : invariant() : void 0;
...
function createRegistry() {
  ...
  function getDraggableById(id) {
    ...
    !entry ? true ? invariant(false, `Cannot find draggable entry with id [${id}]`) : invariant() : void 0;
    return entry;
  }
  const draggableAPI = {
    register: (entry) => {
  ...
  function getDroppableById(id) {
    ...
    !entry ? true ? invariant(false, `Cannot find droppable entry with id [${id}]`) : invariant() : void 0;
    return entry;
  }
  const droppableAPI = {
    register: (entry) => {
...
var getBodyElement = () => {
  ...
  !body ? true ? invariant(false, "Cannot find document.body") : invariant() : void 0;
  return body;
};
var visuallyHidden = {
  position: "absolute",
...
var getVersion = (value) => {
  ...
  !(result != null) ? true ? invariant(false, `Unable to parse React version ${value}`) : invariant() : void 0;
...
function create() {
  ...
  function claim(abandon) {
    !!lock ? true ? invariant(false, "Cannot claim lock as it is already claimed") : invariant() : void 0;
    const newLock = {
      abandon
    };
    lock = newLock;
  ...
  function release() {
    !lock ? true ? invariant(false, "Cannot release lock when there is no lock") : invariant() : void 0;
    lock = null;
  }
  function tryAbandon() {
    if (lock) {
...
function getCaptureBindings({
  ...
  return [{
    ...
    fn: (event) => {
      ...
      !(phase.type === "PENDING") ? true ? invariant(false, "Cannot be IDLE") : invariant() : void 0;
    ...
    fn: (event) => {
      const phase = getPhase();
      !(phase.type !== "IDLE") ? true ? invariant(false, "Unexpected phase") : invariant() : void 0;
...
function useMouseSensor(api) {
  ...
  const startPendingDrag = useCallback2(function startPendingDrag2(actions, point) {
    !(phaseRef.current.type === "IDLE") ? true ? invariant(false, "Expected to move from IDLE to PENDING drag") : invariant() : void 0;
    phaseRef.current = {
      type: "PENDING",
      point,
      actions
...
function useKeyboardSensor(api) {
  ...
  const startCaptureBinding = useMemo2(() => ({
    ...
    fn: function onKeyDown(event) {
      ...
      unbindEventsRef.current();
      function stop() {
        !isCapturing ? true ? invariant(false, "Cannot stop capturing a keyboard drag when not capturing") : invariant() : void 0;
        isCapturing = false;
        unbindEventsRef.current();
        listenForCapture();
      }
...
function getHandleBindings({
  ...
  return [{
    ...
    fn: (event) => {
      const phase = getPhase();
      !(phase.type !== "IDLE") ? true ? invariant() : invariant() : void 0;
...
function useTouchSensor(api) {
  ...
  const startDragging = useCallback2(function startDragging2() {
    const phase = getPhase();
    !(phase.type === "PENDING") ? true ? invariant(false, `Cannot start dragging from phase ${phase.type}`) : invariant() : void 0;
  ...
  const startPendingDrag = useCallback2(function startPendingDrag2(actions, point) {
    !(getPhase().type === "IDLE") ? true ? invariant(false, "Expected to move from IDLE to PENDING drag") : invariant() : void 0;
...
function tryStart({
  ...
  function lift2(args) {
    ...
    if (phase !== "PRE_DRAG") {
      completed();
      true ? invariant(false, `Cannot lift in phase ${phase}`) : invariant();
    }
...
function getStore(lazyRef) {
  !lazyRef.current ? true ? invariant(false, "Could not find store from lazy ref") : invariant() : void 0;
...
function useDraggablePublisher(args) {
  ...
  const getDimension2 = useCallback2((windowScroll) => {
    ...
    !el ? true ? invariant(false, "Cannot get dimension when no ref is set") : invariant() : void 0;
...
function useRequiredContext(Context) {
  ...
  !result ? true ? invariant(false, "Could not find required context") : invariant() : void 0;
  return result;
}
...
var isBodyScrollable = () => {
  ...
  !html ? true ? invariant() : invariant() : void 0;
...
function useDroppablePublisher(args) {
  ...
  const memoizedUpdateScroll = useMemo2(() => memoizeOne((x, y) => {
    !whileDraggingRef.current ? true ? invariant(false, "Can only update scroll when dragging") : invariant() : void 0;
    const scroll3 = {
      x,
      y
    };
  ...
  const onClosestScroll = useCallback2(() => {
    ...
    !(dragging && closest2) ? true ? invariant(false, "Could not find scroll options while scrolling") : invariant() : void 0;
  ...
  const getDimensionAndWatchScroll = useCallback2((windowScroll, options) => {
    !!whileDraggingRef.current ? true ? invariant(false, "Cannot collect a droppable while a drag is occurring") : invariant() : void 0;
    const previous = previousRef.current;
    const ref2 = previous.getDroppableRef();
    !ref2 ? true ? invariant(false, "Cannot collect without a droppable ref") : invariant() : void 0;
  ...
  const getScrollWhileDragging = useCallback2(() => {
    const dragging = whileDraggingRef.current;
    const closest2 = getClosestScrollableFromDrag(dragging);
    !(dragging && closest2) ? true ? invariant(false, "Can only recollect Droppable client for Droppables that have a scroll container") : invariant() : void 0;
    return getScroll(closest2);
  }, []);
  const dragStopped = useCallback2(() => {
    const dragging = whileDraggingRef.current;
    !dragging ? true ? invariant(false, "Cannot stop drag when no active drag") : invariant() : void 0;
    const closest2 = getClosestScrollableFromDrag(dragging);
  ...
  const scroll2 = useCallback2((change) => {
    const dragging = whileDraggingRef.current;
    !dragging ? true ? invariant(false, "Cannot scroll when there is no drag") : invariant() : void 0;
    const closest2 = getClosestScrollableFromDrag(dragging);
    !closest2 ? true ? invariant(false, "Cannot scroll a droppable with no closest scrollable") : invariant() : void 0;
...
var shared = [function required({
  ...
  !props.droppableId ? true ? invariant(false, "A Droppable requires a droppableId prop") : invariant() : void 0;
  !(typeof props.droppableId === "string") ? true ? invariant(false, `A Droppable requires a [string] droppableId. Provided: [${typeof props.droppableId}]`) : invariant() : void 0;
}, function boolean({
  props
}) {
  !isBoolean(props.isDropDisabled) ? true ? invariant(false, "isDropDisabled must be a boolean") : invariant() : void 0;
  !isBoolean(props.isCombineEnabled) ? true ? invariant(false, "isCombineEnabled must be a boolean") : invariant() : void 0;
  !isBoolean(props.ignoreContainerClipping) ? true ? invariant(false, "ignoreContainerClipping must be a boolean") : invariant() : void 0;
}, function ref({
  getDroppableRef
}) {
...
var virtual = [function hasClone({
  ...
  !props.renderClone ? true ? invariant(false, "Must provide a clone render function (renderClone) for virtual lists") : invariant() : void 0;
}, function hasNoPlaceholder({
  getPlaceholderRef
}) {
  !!getPlaceholderRef() ? true ? invariant(false, "Expected virtual list to not have a placeholder") : invariant() : void 0;
}];
...
var Droppable = (props) => {
  ...
  !appContext ? true ? invariant(false, "Could not find app context") : invariant() : void 0;
  const {
    contextId,
...
function getBody() {
  !document.body ? true ? invariant(false, "document.body is not ready") : invariant() : void 0;
