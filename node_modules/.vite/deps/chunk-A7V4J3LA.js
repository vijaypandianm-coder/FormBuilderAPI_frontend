...
// node_modules/vitest/dist/chunks/index.Dc3xnDvT.js
...
function any(names, options) {
  ...
  for (dir of up(start, options)) {
    for (j = 0; j < len; j++) {
      tmp = (0, import_node_path.join)(dir, names[j]);
...
function requirePrompt$1() {
  ...
  const readline = import_readline.default;
...
var prompt = getDefaultExportFromCjs(promptsExports);
...
//# sourceMappingURL=chunk-A7V4J3LA.js.map
